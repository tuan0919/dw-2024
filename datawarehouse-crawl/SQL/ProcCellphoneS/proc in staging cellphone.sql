...
drop procedure if exists transform_and_cleaning_data_cellphone;
delimiter //
create procedure transform_and_cleaning_data_cellphone()
begin
	/*
...
INSERT INTO staging_mouse_daily_cellphone (
    product_name,
    price,
    image,
    length,
...
DELETE s1
	FROM
		staging_mouse_daily_cellphone s1
	JOIN
		staging_mouse_daily_cellphone s2
	ON
...
DELETE FROM staging_mouse_daily_cellphone
WHERE
